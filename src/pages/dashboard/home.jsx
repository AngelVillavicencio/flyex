...
return (
    ...
    <div className="mt-12 px-4">
        <Typography variant="h6" color="blue-gray" className="mb-4">Métricas de la cuenta</Typography>
        <div className="mb-4 grid gap-y-4 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
        ...
        <Card className="overflow-hidden xl:col-span-2 border border-blue-gray-100 shadow-sm">
            ...
            <div>
                <Typography variant="h6" color="blue-gray" className="mb-1">Postulaciones</Typography>
                <Typography variant="small" className="flex items-center gap-1 font-normal text-blue-gray-600">
                <CheckCircleIcon strokeWidth={3} className="h-4 w-4 text-green-200" />
                <strong>5 postulaciones</strong> este mes
                </Typography>
            </div>
            ...
            <table className="w-full min-w-[640px] table-auto">
                <thead>
                <tr>
                    {["postulaciones", "postulantes", "budget", "completion"].map(el => (
                ...
                {projectsTableData.map(({ img, name, members, budget, completion }, key) => {
                    ...
                    <tr key={name}>
                        ...
                        <td className={className}>
                        <Typography variant="small" className="text-xs font-medium text-blue-gray-600">{budget}</Typography>
                        </td>
                        <td className={className}>
                        <div className="w-10/12">
                            <Typography variant="small" className="mb-1 block text-xs font-medium text-blue-gray-600">{completion}%</Typography>
