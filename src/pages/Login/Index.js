...
import { useAuth } from "../../app/features/context/authContext/Index";
import { Link } from "react-router-dom";
import { Button, Input, Row, Col, Form, Checkbox, message } from "antd";
import { UserOutlined, KeyOutlined } from "@ant-design/icons";
import "./App.css";
import { createUser, logIn, logOut } from "../../app/services/firebase/authFirebase";
import Header from "../../app/components/Header";
import { getAllUsers } from "../../app/services/firebase/usuarios";
...
const Index = () => {
  ...
  const onSubmitSuccess = ({ email, password }) => {
    ...
    logIn(email, password)
      .then(async (res) => {
        ...
        console.log("USER CACHE", { ...res.user })
        navigate("/");
        console.log("Success");
  ...
  return (
    <div className="relative bg-[conic-gradient(at_bottom_left,_var(--tw-gradient-stops))] from-sky-400 via-white to-blue-600 h-screen" >
      {contextHolder}
      <div
                  ...
                  >
                    ...
                    >
                      <div class="mb-10 text-center">
                        ...
                        >
                          <h2 className="text-2xl">Hotel Admin</h2>
                        </Link>
                      </div>
                      <div class="mb-8">
                        <Form.Item
